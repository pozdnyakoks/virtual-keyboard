export function toRuKeyboard() {
  localStorage.lang = 'ru';

  function changeTextContent(attribute, textContent) {
    return document.querySelector(attribute).textContent = textContent
  }

  changeTextContent('[data-key="Backquote"] .first', '')
  ...
  changeTextContent('[data-key="BracketLeft"] .first', '')
  changeTextContent('[data-key="BracketLeft"] .second', 'Х')
  changeTextContent('[data-key="BracketRight"] .first', '')
  ...
  changeTextContent('[data-key="Semicolon"] .first', '')
  changeTextContent('[data-key="Semicolon"] .second', 'Ж')
  changeTextContent('[data-key="Quote"] .first', '')
  ...
  changeTextContent('[data-key="Comma"] .first', '')
  changeTextContent('[data-key="Comma"] .second', 'Б')
  changeTextContent('[data-key="Period"] .first', '')
